 ...
 * @author rodri
 */
public class TelaLogin1 extends javax.swing.JDialog {
    ...
    public TelaLogin1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaLogin1 dialog = new TelaLogin1(new javax.swing.JFrame(), true);
